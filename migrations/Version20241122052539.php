 ...
 */
final class Version20241122052539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE remedy_stock (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, remedy_recipe_id INT DEFAULT NULL, quantity INT NOT NULL, unity VARCHAR(100) NOT NULL, INDEX IDX_FD5788B3A76ED395 (user_id), INDEX IDX_FD5788B3B4CAE006 (remedy_recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
